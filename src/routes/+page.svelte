...
<main class="mx-auto flex h-screen gap-2">
	<div
		class={cn(
			...
			"lg:m-2 lg:mr-0 lg:w-80 lg:rounded-xl lg:border",
	...
	>
		<button
			...
			class={cn(
				"block h-10 w-full rounded-t-lg border bg-white px-4 py-2 transition-all lg:hidden",
		...
		>
			...
			<div class="flex flex-1 items-end justify-end gap-1 p-1 text-xs">
				<a
					...
					target="_blank"
					rel="noopener noreferrer">Built by Ibrahim Raimi</a
				>
